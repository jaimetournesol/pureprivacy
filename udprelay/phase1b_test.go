...
func TestOnionCatIPv6Deterministic(t *testing.T) {
	a, err := onioncatIPv6("yy3j5psigppxqgy5pm7rjjqm2im37pwjcovliqabruffzezkzkjellid.onion")
	if err != nil {
		t.Fatalf("first call: %v", err)
	}
	b, err := onioncatIPv6("YY3J5PSIGPPXQGY5PM7RJJQM2IM37PWJCOVLIQABRUFFZEZKZKJELLID")
	if err != nil {
...
func TestOnionCatIPv6Distinct(t *testing.T) {
	a, _ := onioncatIPv6("yy3j5psigppxqgy5pm7rjjqm2im37pwjcovliqabruffzezkzkjellid.onion")
	b, _ := onioncatIPv6("rcr4ole6mjo3amezj2qgda5nltrqui5tadimy44ozezwdeobfuayqwyd.onion")
	if a.Equal(b) {
